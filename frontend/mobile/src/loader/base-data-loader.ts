import { fetchAllBaseItems, fetchAllFlavours, fetchAllItemOptionMaps, fetchAllItems, fetchAllOptions, fetchAllSizes, fetchAllTables } from '@/utilities/fetchUtility'
import { NavigationResult } from 'unplugin-vue-router/data-loaders'
import { defineBasicLoader } from 'unplugin-vue-router/data-loaders/basic'
export const useBaseDataLoader = defineBasicLoader('/order', async (to) => {
