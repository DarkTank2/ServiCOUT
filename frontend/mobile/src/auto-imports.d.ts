...
declare global {
  ...
  const useCalculatorStore: typeof import('./stores/calculator-store').useCalculatorStore
  const useCashStore: typeof import('./stores/cash-store').useCashStore
  ...
  const useKeybindings: typeof import('./stores/keybindings-store').useKeybindings
  const useMobileSettings: typeof import('./stores/mobile-settings-store').useMobileSettings
  const useModel: typeof import('vue').useModel
  const useRoute: typeof import('vue-router').useRoute
  const useRouter: typeof import('vue-router').useRouter
  const useServiceInstance: typeof import('feathers-pinia').useServiceInstance
  const useSettings: typeof import('./stores/settings-store').useSettings
  const useSlots: typeof import('vue').useSlots
  const useStationarySettings: typeof import('./stores/stationary-settings-store').useStationarySettings
  const useTemplateRef: typeof import('vue').useTemplateRef
  const useUtilityStore: typeof import('./stores/utility-store').useUtilityStore
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly useKeybindings: UnwrapRef<typeof import('./stores/keybindings-store')['useKeybindings']>
    readonly useMobileSettings: UnwrapRef<typeof import('./stores/mobile-settings-store')['useMobileSettings']>
